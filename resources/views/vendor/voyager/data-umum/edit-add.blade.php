            ...
            <div class="panel panel-bordered">
                ...
                <form role="form" class="form-edit-add"
                    ...
                    <div class="panel-body">
                        ...
                        @elseif ($row->field=='id_tipe_pendaftara')
                        <input type="hidden" name="{{ $row->field }}" value="{{ Auth::user()->id }}">
                        @elseif ($row->field=='AUTH_ID')
                        <input type="hidden" name="{{ $row->field }}" value="{{ Auth::user()->id }}">
                        @elseif ($row->field=='id')
                        <input type="hidden" name="{{ $row->field }}" value="{{ Auth::user()->id }}">
                    ...
                    <div class="panel-footer">
                        ...
                        <button type="submit" class="btn btn-primary save col-12" id="tombolsimpan" onclick="pwir()">{{
                            __('voyager::generic.save') }}</button>
                        <a href="#" class="btn btn-light save hiow col-12 text-center" id="benpas">
